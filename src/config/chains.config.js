...
module.exports = {
  ...
  getEVMChains: () => {
    return Object.values(CHAINS).filter(chain => chain.type === CHAIN_TYPES.EVM);
  },

  getUTXOChains: () => {
    return Object.values(CHAINS).filter(chain => chain.type === CHAIN_TYPES.UTXO);
  },
